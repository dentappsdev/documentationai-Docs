...
<Callout kind="info" title="Monthly usage limit">
Diagnostic reports are part of your AI diagnostic chat allowance of **30 conversations per month**. This limit resets at the start of each billing cycle.

When you reach your monthly limit, a message appears showing your usage and the number of days until your limit resets. You can still schedule service manually.

Monitor your usage from the **Usage** tab in [Office Settings](/settings/office-settings).
</Callout>
