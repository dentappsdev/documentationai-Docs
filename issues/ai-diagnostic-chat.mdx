...
AI diagnostic chats are limited to **30 conversations per month**. This limit resets at the start of each billing cycle.

When you reach your monthly limit, a modal appears explaining the limit and when it resets. You can monitor your usage from the **Usage** tab in [Office Settings](/settings/office-settings).
</Callout>
