---
title: Key Concepts
description: Understand the core building blocks of ChairPulse, including equipment categories, room types, compliance primitives, your subscription plan, user roles, and task management.
---
...
ChairPulse uses a single, all-inclusive plan at **$159/month per office**. Every subscriber gets full access to all features:

| Feature | Included |
|---|---|
| Equipment management, issues, maintenance, checklists | Yes |
| Full compliance wizard with county-level requirements | Yes |
| AI diagnostic chats | 30/month |
| Detailed SOP generation | 100/month |
| Standard SOP generation | Unlimited |
| Team members | Up to 25 |
| Learning paths | Yes |
| Invoice uploads and analytics | Yes |

<Callout kind="info" title="Trial period">

New accounts start with a free trial that includes full access to all features. This lets you evaluate everything ChairPulse offers — the compliance wizard, learning paths, AI diagnostics, and more — before subscribing.
